	...
	public FilterSameSetWmeEventFollowsRelation(ProcessInstance pi,
		...
		if (pi != null) {
			...
			try {
				...
				System.err
						.println("Could not create an AuditTrailEntryListImpl in constructor of the class org.staticgenerator.exporting.log.util.FilterPerWorkflowModelElementAndEvent!");
			}
