...
public class GGAdapter extends GGGraph {
	...
	protected class GGFuzzyGraphAdapter extends GGGraphAdapter {
		 ...
		 * 
		 * @see
		 * org.staticgenerator.mining.fuzzymining.gantzgraf.util.GGGraphAdapter
		 * #nodeSelected
		 * (org.staticgenerator.mining.fuzzymining.gantzgraf.painter.GGCanvas,
		 * org.staticgenerator.mining.fuzzymining.gantzgraf.model.GGGraph,
		 * org.staticgenerator.mining.fuzzymining.gantzgraf.model.GGNode, float,
		 * float)
		 */
		@Override
