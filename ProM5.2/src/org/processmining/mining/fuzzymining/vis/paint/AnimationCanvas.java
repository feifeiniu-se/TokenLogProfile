...
public class AnimationCanvas extends JComponent implements AnimationListener {
	 ...
	 * (non-Javadoc)
	 * 
	 * @seeorg.staticgenerator.mining.fuzzymining.anim.model.AnimationListener#
	 ...
	 * 
	 * @see
	 * org.staticgenerator.mining.fuzzymining.vis.anim.AnimationListener#started()
	 */
	public void started() {
	 ...
	 * 
	 * @see
	 * org.staticgenerator.mining.fuzzymining.vis.anim.AnimationListener#stopped()
	 */
	public void stopped() {
		// ignore for now, we just paint the current state
	}
