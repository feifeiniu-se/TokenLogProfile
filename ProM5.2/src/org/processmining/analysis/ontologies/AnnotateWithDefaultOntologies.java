...
public class AnnotateWithDefaultOntologies {
	...
	public static OntologySummaryResults analyse(LogReader inputLog)
		...
		OntologyModel tasks = log.getLogSummary().getOntologies()
				.createOntology(
						"http://www.staticgenerator.org/ontologies/TaskOntology",
						"TaskOntology");
		OntologyModel originators = log
				.getLogSummary()
				.getOntologies()
				.createOntology(
						"http://www.staticgenerator.org/ontologies/OriginatorOntology",
						"OriginatorOntology");
		OntologyModel eventtypes = log.getLogSummary().getOntologies()
				.createOntology("http://www.staticgenerator.org/ontologies/EVO",
						"EVO");
		OntologyModel PIs = log
				.getLogSummary()
				.getOntologies()
				.createOntology(
						"http://www.staticgenerator.org/ontologies/ProcessInstanceOntology",
						"ProcessInstanceOntology");
		OntologyModel processes = log
				.getLogSummary()
				.getOntologies()
				.createOntology(
						"http://www.staticgenerator.org/ontologies/ProcessOntology",
						"ProcessOntology");
		OntologyModel workflowlogs = log
				.getLogSummary()
				.getOntologies()
				.createOntology(
						"http://www.staticgenerator.org/ontologies/WorkFlowLogOntology",
						"WorkFlowLogOntology");
		OntologyModel sources = log
				.getLogSummary()
				.getOntologies()
				.createOntology(
						"http://www.staticgenerator.org/ontologies/SourceOntology",
						"SourceOntology");
		OntologyModel datafields = log
				.getLogSummary()
				.getOntologies()
				.createOntology(
						"http://www.staticgenerator.org/ontologies/DataFieldOntology",
						"DataFieldOntology");
