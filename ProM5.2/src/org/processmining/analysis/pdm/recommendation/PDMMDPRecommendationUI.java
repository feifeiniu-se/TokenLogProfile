...
import org.processmining.analysis.recommendation.LogBasedRecommendationUI; //import org.staticgenerator.analysis.recommendation.MyTableModel;
...
public class PDMMDPRecommendationUI extends JPanel {
	...
	public PDMMDPRecommendationUI(final PDMStateSpace statespace,
		...
		{ // Strategy selection part
			...
			// contributors.add("Minimize staticgenerator time");
			// contributors.add("Maximize cost");
			// contributors.add("Maximize staticgenerator time");
		 ...
		 * (getSelectedStrategy().equals("Minimize staticgenerator time")){ Vector
