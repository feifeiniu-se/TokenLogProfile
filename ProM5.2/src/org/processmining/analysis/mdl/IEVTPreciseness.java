...
public class IEVTPreciseness extends MDLPrecisenessMetric {
	...
	class IEVTEncoder extends PrecisenessMeasurer {
		 ...
		 * org.staticgenerator.analysis.mdl.MDLPrecisenessMetric.PrecisenessMeasurer
		 * #
		 * takeFailedTaskMeasurement(org.staticgenerator.framework.models.petrinet
		 * .algorithms.logReplay.ReplayedLogTrace,
		 * org.staticgenerator.framework.models
		 * .petrinet.algorithms.logReplay.ReplayedTransition,
		 * org.staticgenerator.framework.log.AuditTrailEntry)
		 */
