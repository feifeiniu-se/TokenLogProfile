...
public class ImportAnyFileAction extends CatchOutOfMemoryAction {
	 ...
	 * 
	 * @see
	 * org.staticgenerator.framework.ui.actions.CatchOutOfMemoryAction#execute
	 ...
	 * 
	 * @see
	 * org.staticgenerator.framework.ui.actions.CatchOutOfMemoryAction#handleOutOfMem
	 * ()
	 */
	@Override
	...
	protected class MxmlImportPlugin implements ImportPlugin {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.staticgenerator.importing.ImportPlugin#getFileFilter()
		 */
		 ...
		 * 
		 * @see
		 * org.staticgenerator.importing.ImportPlugin#importFile(java.io.InputStream
		 * )
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.staticgenerator.framework.plugin.Plugin#getHtmlDescription()
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.staticgenerator.framework.plugin.Plugin#getName()
		 */
