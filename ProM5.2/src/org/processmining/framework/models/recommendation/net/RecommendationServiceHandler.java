...
public class RecommendationServiceHandler implements ServiceHandler {
	 ...
	 * 
	 * @see
	 * org.staticgenerator.framework.remote.ServiceHandler#handleRequest(java.
	...
	protected void handleRecommendationRequest(BufferedReader in,
		...
		try {
			...
			e.printStackTrace();
			Message.add("Exception thrown staticgenerator your query:"
					+ e.toString(), Message.ERROR);
			sendError(out, "Exception thrown staticgenerator your query:", e);
			return; // give up
		}
