...
public class RecommendationCompletedTraceMarshal {
	...
	protected class StringLogFile extends LogFile {
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.staticgenerator.framework.log.LogFile#getInputStream()
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.staticgenerator.framework.log.LogFile#getShortName()
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.staticgenerator.framework.log.LogFile#toString()
		 */
		@Override
