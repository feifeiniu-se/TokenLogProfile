...
public class HLBooleanDistributionGui extends HLAttributeValueGui {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.staticgenerator.framework.util.GuiDisplayable#getPanel()
	 */
	 ...
	 * 
	 * @see
	 * org.staticgenerator.framework.models.hlprocess.gui.HLAttributeValueGui#
	 * disable()
	 */
	public void disable() {
	...
	// /*
	// * (non-Javadoc)
	// * @see org.staticgenerator.framework.util.GuiNotificationTarget#updateGUI()
	// */
