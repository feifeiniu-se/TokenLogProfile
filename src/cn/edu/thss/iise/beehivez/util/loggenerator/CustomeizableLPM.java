...
//			for(int times = 0; times < 10; times ++) {
				...
				casesNumber += TarCompleteMethod(fileDir, pn, comPara, noiPara);
				long endTime = System.currentTimeMillis();
				allTime += endTime - startTime;
//			}
			System.out.println("" + new File(fileDir).getName().split("\\.")[0] + "\t" + allTime + "\t" + casesNumber);
		}
			...
			for(int times = 0; times < 10; times ++) {
				long startTime = System.currentTimeMillis();
				casesNumber += CauCompleteMethod(fileDir, pn,comPara, noiPara);
				long endTime = System.currentTimeMillis();
				allTime += endTime - startTime;
			}
			System.out.println("" + allTime/10 + "\t" + casesNumber/10);
		}
...
//			for (int times = 0; times < 10; times++) {
				...
				allTime += endTime - startTime;
//			}
//			System.out.println(new File(fileDir).getName().split("\\.")[0] + "\t" + allTime + "\t" + log.size() + "\t" +
//					ConcurrentAndLoopStatistics.loops + "\t" + ConcurrentAndLoopStatistics.totalAveragePathLength);
			System.out.print("" + ConcurrentAndLoopStatistics.finalTraces + ", ");
		}
		else{	
