		...
		if (chooseModel == null) {
			...
			chooseModel.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					JFileChooser fileChooser = new JFileChooser("C:\\Users\\Chuanyi Li\\Documents\\Research\\TAR\\Data\\ModelsB");
		...
		if (submit == null) {
			...
			submit.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					String foldername = "C:\\Users\\Chuanyi Li\\Documents\\Research\\TAR\\Data\\Logs";
