...
public abstract class Tokenizer extends TokenStream {
  ...
  /** Construct a token stream staticgenerator the given input. */
  ...
  /** Construct a token stream staticgenerator the given input using the given AttributeFactory. */
  protected Tokenizer(AttributeFactory factory, Reader input) {
    super(factory);
    this.input = CharReader.get(input);
  }

  /** Construct a token stream staticgenerator the given input using the given AttributeSource. */
